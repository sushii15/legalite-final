...
const aibeText = readFileSync('./aibe8_extracted.txt', 'utf-8')
...
// Missing questions
const missingQs = [4, 7, 10, 12, 19, 20, 21, 22, 29, 31, 32, 35, 46, 56, 76, 79, 87]
...
// Write to JSON
writeFileSync('./aibe8_missing_17.json', JSON.stringify(questions, null, 2))
...
if (stillMissing.length > 0) {
  ...
  console.log(`✅ All 17 missing questions extracted!`)
}
