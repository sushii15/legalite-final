...
const aibeText = readFileSync('./aibe6_extracted.txt', 'utf-8').replace(/\r/g, '')
...
writeFileSync('./aibe6_all_100_questions.json', JSON.stringify(questions, null, 2))

console.log(`✅ Parsed AIBE 6: ${questions.length} questions`)
