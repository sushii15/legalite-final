...
const aibeText = readFileSync('./aibe10_extracted.txt', 'utf-8')
...
// Missing questions
const missingQs = [6, 10, 11, 24, 28, 29, 32, 34, 38, 39, 44, 45, 50, 52, 55, 56, 61, 64, 65, 68, 69, 71, 72, 73, 74, 75, 82, 85, 87, 88, 99]
...
// Write to JSON
writeFileSync('./aibe10_missing_31.json', JSON.stringify(questions, null, 2))
...
if (stillMissing.length > 0) {
  ...
  console.log(`✅ All 31 missing questions extracted!`)
}
