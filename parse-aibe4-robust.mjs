...
const aibeText = readFileSync('./aibe4_extracted.txt', 'utf-8').replace(/\r/g, '')
...
// Write to JSON
writeFileSync('./aibe4_questions_parsed.json', JSON.stringify(questions, null, 2))

console.log(`✅ Parsed AIBE 4`)
