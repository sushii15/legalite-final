...
// Read all JSON files
const parsed = JSON.parse(readFileSync('./aibe5_questions_parsed.json', 'utf-8'))
const missing = JSON.parse(readFileSync('./aibe5_missing.json', 'utf-8'))
...
// Write final file
writeFileSync('./aibe5_all_100_questions_final.json', JSON.stringify(unique, null, 2))

console.log(`✅ Merged all AIBE 5 sources`)
...
if (missing_qs.length > 0) {
  ...
  console.log(`✅ ALL 100 AIBE 5 QUESTIONS COMPLETE!`)
}
