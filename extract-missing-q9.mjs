...
// Missing questions
const missingQs = [2, 3, 6, 7, 10, 11, 14, 17, 18, 20, 21, 22, 26, 29, 30, 32, 33, 38, 41, 42, 43, 47, 50, 54, 56, 58, 60, 61, 62, 64, 68, 69, 73, 74, 78, 82, 83, 84, 86, 87, 88, 89, 92, 94, 95, 100]
...
// Write to JSON
writeFileSync('./aibe9_missing_46.json', JSON.stringify(questions, null, 2))
...
if (stillMissing.length > 0) {
  ...
  console.log(`✅ All 46 missing questions extracted!`)
}
